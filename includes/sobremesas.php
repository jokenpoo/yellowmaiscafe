...
<div id="accordion">
    <div class="card bg-transparent border-0 ">
        <div class="card-header border-0 mb-0 bg-transparent">
            <button class="btn btn-link btn-block text-left btn-lg text-dark " data-target="#collapse2" data-toggle="collapse">
                Sobremesas
            </button>
        ...
        $sql = "SELECT * FROM produtos WHERE categoria like 'Sobremesas'";
